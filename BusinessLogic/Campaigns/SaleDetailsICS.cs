...
namespace BusinessLogic.Campaigns
{
	public class SaleDetailsICS
	{
		...
		public static SaleDetailsICS GetSaleDetails(int saleID)
		{
			SaleDetailsICS retVal = new SaleDetailsICS();
		...
		private static SaleDetailsICS MakeObject(DataRow inputRow)
		{
			SaleDetailsICS retValue = new SaleDetailsICS();
