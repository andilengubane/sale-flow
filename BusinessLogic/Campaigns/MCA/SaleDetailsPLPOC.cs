...
namespace BusinessLogic.Campaigns.MCA
{
    public class SaleDetailsPLPOC
    {
        ...
        public static SaleDetailsPLPOC GetSaleDetails(int saleID)
        {
            SaleDetailsPLPOC retVal = new SaleDetailsPLPOC();
            ...
            string sql = "select * from Sales_Details_MCAPLPOC where SalesID = @salesID";
               ...
               string CreatedBy, string UpdatedBy, string SaleType)
        {
            ...
            string sql = "spCreateSales_Details_MCAPLPOC";

            retval = Convert.ToInt32(DataAccess.ExecuteSpScalar(sql, parm));

            return retval;
        }
        private static SaleDetailsPLPOC MakeObject(DataRow inputRow)
        {
            SaleDetailsPLPOC retValue = new SaleDetailsPLPOC();
