...
namespace BusinessLogic.Campaigns.MCA
{
    public class ProductsCOMP
    {
        ...
        public static List<ProductsCOMP> GetProducts()
        {
            List<ProductsCOMP> retVal = new List<ProductsCOMP>();
            ...
            string sql = "select * from Products_MCACOMP where IsActive = @IsActive";
        ...
        private static ProductsCOMP MakeObject(DataRow inputRow)
        {
            ProductsCOMP retValue = new ProductsCOMP();
