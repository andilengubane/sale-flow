...
namespace BusinessLogic.Campaigns.MCA
{
    public class SaleDetailsPLGEN
    {
        ...
        public static SaleDetailsPLGEN GetSaleDetails(int saleID)
        {
            SaleDetailsPLGEN retVal = new SaleDetailsPLGEN();
            ...
            string sql = "select * from Sales_Details_MCAPLGEN where SalesID = @salesID";
               ...
               string CreatedBy, string UpdatedBy, string SaleType)
        {
            ...
            string sql = "spCreateSales_Details_MCAPLGEN";

            retval = Convert.ToInt32(DataAccess.ExecuteSpScalar(sql, parm));

            return retval;
        }
        private static SaleDetailsPLGEN MakeObject(DataRow inputRow)
        {
            SaleDetailsPLGEN retValue = new SaleDetailsPLGEN();
