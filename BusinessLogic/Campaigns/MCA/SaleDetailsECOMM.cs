...
namespace BusinessLogic.Campaigns.MCA
{
    public class SaleDetailsECOMM
    {
        ...
        public static SaleDetailsECOMM GetSaleDetails(int saleID)
        {
            SaleDetailsECOMM retVal = new SaleDetailsECOMM();
            ...
            string sql = "select * from Sales_Details_MCAECOMM where SalesID = @salesID";
               ...
               string CreatedBy, string UpdatedBy, string SaleType)
        {
            ...
            string sql = "spCreateSales_Details_MCAECOMM";

            retval = Convert.ToInt32(DataAccess.ExecuteSpScalar(sql, parm));

            return retval;
        }
        private static SaleDetailsECOMM MakeObject(DataRow inputRow)
        {
            SaleDetailsECOMM retValue = new SaleDetailsECOMM();
