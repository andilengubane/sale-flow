...
{
    public class SaleDetailsDSTVIDP
    {
        ...
        public static SaleDetailsDSTVIDP GetSaleDetails(int saleID)
        {
            SaleDetailsDSTVIDP retVal = new SaleDetailsDSTVIDP();
            ...
            string sql = "select * from Sales_Details_DSTVIDP where SalesID = @salesID";
               ...
               string CreatedBy, string UpdatedBy, string SaleType)
        {
            ...
            string sql = "spCreateSales_Details_DSTVIDP";

            retval = Convert.ToInt32(DataAccess.ExecuteSpScalar(sql, parm));

            return retval;
        }
        private static SaleDetailsDSTVIDP MakeObject(DataRow inputRow)
        {
            SaleDetailsDSTVIDP retValue = new SaleDetailsDSTVIDP();
