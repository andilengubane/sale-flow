...
namespace BusinessLogic.Campaigns.MCA
{
    public class SaleDetailsPLSD
    {
        ...
        public static SaleDetailsPLSD GetSaleDetails(int saleID)
        {
            SaleDetailsPLSD retVal = new SaleDetailsPLSD();
            ...
            string sql = "select * from Sales_Details_MCAPLSD where SalesID = @salesID";
               ...
               string CreatedBy, string UpdatedBy)
        {
            ...
            string sql = "spCreateSales_Details_MCAPLSD";

            retval = Convert.ToInt32(DataAccess.ExecuteSpScalar(sql, parm));

            return retval;
        }
        private static SaleDetailsPLSD MakeObject(DataRow inputRow)
        {
            SaleDetailsPLSD retValue = new SaleDetailsPLSD();
