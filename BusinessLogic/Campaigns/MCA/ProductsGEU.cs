...
namespace BusinessLogic.Campaigns.MCA
{
    public class ProductsGEU
    {
        ...
        public static List<ProductsGEU> GetProducts()
        {
            List<ProductsGEU> retVal = new List<ProductsGEU>();
            ...
            string sql = "select * from Products_MCAGEU where IsActive = @IsActive";
        ...
        private static ProductsGEU MakeObject(DataRow inputRow)
        {
            ProductsGEU retValue = new ProductsGEU();
