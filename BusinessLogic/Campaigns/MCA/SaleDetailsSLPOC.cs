...
namespace BusinessLogic.Campaigns.MCA
{
    public class SaleDetailsSLPOC
    {
        ...
        public static SaleDetailsSLPOC GetSaleDetails(int saleID)
        {
            SaleDetailsSLPOC retVal = new SaleDetailsSLPOC();
            ...
            string sql = "select * from Sales_Details_MCASLPOC where SalesID = @salesID";
               ...
               string CreatedBy, string UpdatedBy, string SaleType)
        {
            ...
            string sql = "spCreateSales_Details_MCASLPOC";

            retval = Convert.ToInt32(DataAccess.ExecuteSpScalar(sql, parm));

            return retval;
        }
        private static SaleDetailsSLPOC MakeObject(DataRow inputRow)
        {
            SaleDetailsSLPOC retValue = new SaleDetailsSLPOC();
