...
namespace BusinessLogic.Campaigns.MCA
{
    public class SaleDetailsPLSED
    {
        ...
        public static SaleDetailsPLSED GetSaleDetails(int saleID)
        {
            SaleDetailsPLSED retVal = new SaleDetailsPLSED();
            ...
            string sql = "select * from Sales_Details_MCAPLSED where SalesID = @salesID";
               ...
               string CreatedBy, string UpdatedBy, string SaleType)
        {
            ...
            string sql = "spCreateSales_Details_MCAPLSED";

            retval = Convert.ToInt32(DataAccess.ExecuteSpScalar(sql, parm));

            return retval;
        }
        private static SaleDetailsPLSED MakeObject(DataRow inputRow)
        {
            SaleDetailsPLSED retValue = new SaleDetailsPLSED();
