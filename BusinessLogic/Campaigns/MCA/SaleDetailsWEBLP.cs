...
namespace BusinessLogic.Campaigns.MCA
{
    public class SaleDetailsWEBLP
    {
        ...
        public static SaleDetailsWEBLP GetSaleDetails(int saleID)
        {
            SaleDetailsWEBLP retVal = new SaleDetailsWEBLP();
            ...
            string sql = "select * from Sales_Details_MCAWEBLP where SalesID = @salesID";
               ...
               string CreatedBy, string UpdatedBy, string SaleType)
        {
            ...
            string sql = "spCreateSales_Details_MCAWEBLP";

            retval = Convert.ToInt32(DataAccess.ExecuteSpScalar(sql, parm));

            return retval;
        }
        private static SaleDetailsWEBLP MakeObject(DataRow inputRow)
        {
            SaleDetailsWEBLP retValue = new SaleDetailsWEBLP();
