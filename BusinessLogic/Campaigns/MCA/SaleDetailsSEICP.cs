...
namespace BusinessLogic.Campaigns.MCA
{
    public class SaleDetailsSEICP
    {
        ...
        public static SaleDetailsSEICP GetSaleDetails(int saleID)
        {
            SaleDetailsSEICP retVal = new SaleDetailsSEICP();
            ...
            string sql = "select * from Sales_Details_MCASEICP where SalesID = @salesID";
               ...
               string CreatedBy, string UpdatedBy, string SaleType)
        {
            ...
            string sql = "spCreateSales_Details_MCASEICP";

            retval = Convert.ToInt32(DataAccess.ExecuteSpScalar(sql, parm));

            return retval;
        }
        private static SaleDetailsSEICP MakeObject(DataRow inputRow)
        {
            SaleDetailsSEICP retValue = new SaleDetailsSEICP();
