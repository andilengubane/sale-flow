...
namespace BusinessLogic.Campaigns.MCA
{
    public class ProductsBOX
    {
        ...
        public static List<ProductsACT> GetProducts()
        {
            List<ProductsACT> retVal = new List<ProductsACT>();
            ...
            string sql = "select * from Products_MCAACT where IsActive = @IsActive";
        ...
        private static ProductsACT MakeObject(DataRow inputRow)
        {
            ProductsACT retValue = new ProductsACT();
