...
namespace BusinessLogic.Campaigns.MCA
{
    public class SaleDetailsEXBUP
    {
        ...
        public static SaleDetailsEXBUP GetSaleDetails(int saleID)
        {
            SaleDetailsEXBUP retVal = new SaleDetailsEXBUP();
            ...
            string sql = "select * from Sales_Details_MCAEXBUP where SalesID = @salesID";
               ...
               string CreatedBy, string UpdatedBy, string SaleType)
        {
            ...
            string sql = "spCreateSales_Details_MCAEXBUP";

            retval = Convert.ToInt32(DataAccess.ExecuteSpScalar(sql, parm));

            return retval;
        }
        private static SaleDetailsEXBUP MakeObject(DataRow inputRow)
        {
            SaleDetailsEXBUP retValue = new SaleDetailsEXBUP();
