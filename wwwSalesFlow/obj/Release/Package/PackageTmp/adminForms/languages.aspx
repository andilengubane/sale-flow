<%@ Page Title="" Language="C#" MasterPageFile="~/adminForms/admin.Master" AutoEventWireup="true" CodeBehind="languages.aspx.cs" Inherits="wwwSalesFlow.adminForms.languages" %>
                        ...
                        <div class="ibox float-e-margins">
                            ...
                            <div class="ibox-content form-horizontal">
                                <div class="form-group">
                                    <div class="col-sm-4">
                                        <asp:Button ID="btnAddLanguage" runat="server" CssClass="btn btn-default btn-info" Text="New Language" OnClick="btnAddLanguage_Click" /></div>              
                                    <div class="col-sm-8"> 
                                        <asp:GridView ID="gvAll" CssClass="table table-hover" runat="server" AutoGenerateColumns="False" DataKeyNames="LanguagesID" OnRowDataBound="gvAll_RowDataBound">
                                            <Columns>
                                                <asp:BoundField DataField="Title" HeaderText="Language" />
                                                <asp:TemplateField>
                                                    <ItemTemplate>
                                                        <asp:LinkButton ID="lnkEdit" ToolTip="Edit language details." runat="server" CssClass="badge" OnClick="lnkEdit_Click">edit</asp:LinkButton>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                            </Columns>
                                        </asp:GridView> 
