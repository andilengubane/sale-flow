<%@ Page Language="C#" MasterPageFile="~/campaignsForms/principal.Master" AutoEventWireup="true" CodeBehind="FNBFUN3.aspx.cs" Inherits="wwwSalesFlow.campaignsForms.FNBFUN3" %>
            ...
            <asp:MultiView ID="mvMain" runat="server">
                    <asp:View ID="vwMain" runat="server">
                        <div class="row wrapper border-bottom white-bg page-heading">
                                <div class="col-lg-10">
                                    <h2>FNB FUNERAL REFRESH (FNBFUN3)</h2>
                                </div>
                                <div class="col-lg-2">
                        ...
                        <div class="wrapper wrapper-content animated fadeInRight">
                            ...
                            <div class="row">
                                ...
                                <div class="ibox float-e-margins">
                                    <div class="ibox-title">
                                        <h5>Beneficiaries / <small> MEMBER ADD-ON</small></h5>
                                        <div class="ibox-tools">
                                            <a class="collapse-link">
                                                <i class="fa fa-chevron-up"></i>
                                            </a>
                                    ...
                                    <div class="ibox-content form-horizontal">
                                            <div class="row">
                                                <div class="panel-heading col-sm-6 img-shadow">
                                                    <h4>
                                                        <span class="badge">&nbsp;Beneficiary 1:&nbsp;<asp:CheckBox ID="chkR1" CssClass="badge" Text="" runat="server" AutoPostBack="True" OnCheckedChanged="chkR1_CheckedChanged" /></span></h4>
                                                    <div class="panel-body">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <asp:TextBox ID="txtRIIdNumber1" runat="server" CssClass="form-control" Enabled="False" onfocusout="validateID()"></asp:TextBox>
                                                        </div>
                                                        <div class="form-group">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <asp:DropDownList ID="cmbRIRelationship1" OnSelectedIndexChanged="cmbRIRelationship1_SelectedIndexChanged" AutoPostBack="true" runat="server" CssClass="form-control" Enabled="False"></asp:DropDownList>
                                                        </div>
                                                        <div class="form-group">
                                                            <label class="control-label">Benefit Amount</label>
                                                            <asp:DropDownList ID="cmbRIBenefitAmount1" OnSelectedIndexChanged="cmbRIBenefitAmount1_SelectedIndexChanged" AutoPostBack="true" runat="server" CssClass="form-control" Enabled="False"></asp:DropDownList>
                                                        </div>
                                                         <div class="form-group">
                                                             <asp:Label ID="lblRIPremiumAmount1" runat="server" Visible="false" Text="Label"></asp:Label><asp:HiddenField ID="hiddenRIPremiumAmount1" Value="0" runat="server" />
                                                         </div>
                                                    </div>
                                                </div>
                                                <div class="panel-heading col-sm-6">
                                                    <h4><span class="badge">&nbsp;Beneficiary 2:&nbsp;<asp:CheckBox ID="chkR2" CssClass="badge" Text="" runat="server" AutoPostBack="True" OnCheckedChanged="chkR2_CheckedChanged" /></span></h4>
                                                    <div class="panel-body">
                                                        <div class="form-group">
                                                            <label class="control-label">Surname</label>
														...
														<div class="form-group">
                                                            <label class="control-label">ID Number</label>
                                                            <asp:TextBox ID="txtRIIdNumber2" runat="server" CssClass="form-control" Enabled="False" onfocusout="validateID2()"></asp:TextBox>
                                                        </div>
                                                        <div class="form-group">
                                                            <label class="control-label">Date of Birth</label>
                                                        ...
                                                        <div class="form-group">
                                                            <label class="control-label">Relationship to Member</label>
                                                            <asp:DropDownList ID="cmbRIRelationship2" runat="server" OnSelectedIndexChanged="cmbRIRelationship2_SelectedIndexChanged" AutoPostBack="true" CssClass="form-control" Enabled="False"></asp:DropDownList>
                                                        </div>
                                                         <div class="form-group">
                                                            <label class="control-label">Benefit Amount</label>
                                                            <asp:DropDownList ID="cmbRIBenefitAmount2" OnSelectedIndexChanged="cmbRIBenefitAmount2_SelectedIndexChanged" AutoPostBack="true" runat="server" CssClass="form-control" Enabled="False"></asp:DropDownList>
                                                        </div>
                                                         <div class="form-group">
                                                             <asp:Label ID="lblRIPremiumAmount2" runat="server" Visible="false" Text="Label"></asp:Label><asp:HiddenField ID="hiddenRIPremiumAmount2" Value="0" runat="server" />
                                                         </div>
                                                    </div>
                                                </div>
                                            </div>
                                        <div class="hr-line-dashed"></div>
                                            <div class="row">
                                                <div class="panel-heading col-sm-6 img-shadow">
                                                    <h4><span class="badge">&nbsp;Beneficiary 3:&nbsp;<asp:CheckBox ID="chkR3" CssClass="badge" Text="" runat="server" AutoPostBack="True" OnCheckedChanged="chkR3_CheckedChanged" /></span></h4>
                                                    <div class="panel-body">
                                                        <div class="form-group">
                                                            <label class="control-label">Surname</label>
														...
														<div class="form-group">
                                                            <label class="control-label">ID Number</label>
                                                            <asp:TextBox ID="txtRIIdNumber3" runat="server" CssClass="form-control" Enabled="False" onfocusout="validateID()"></asp:TextBox>
                                                        </div>
                                                        <div class="form-group">
                                                            <label class="control-label">Date of Birth</label>
                                                        ...
                                                        <div class="form-group">
                                                            <label class="control-label">Relationship to Member</label>
                                                            <asp:DropDownList ID="cmbRIRelationship3" AutoPostBack="true" OnSelectedIndexChanged="cmbRIRelationship3_SelectedIndexChanged" runat="server" CssClass="form-control" Enabled="False"></asp:DropDownList>
                                                        </div>
                                                           <div class="form-group">
                                                            <label class="control-label">Benefit Amount</label>
                                                            <asp:DropDownList ID="cmbRIBenefitAmount3" OnSelectedIndexChanged="cmbRIBenefitAmount3_SelectedIndexChanged" AutoPostBack="true" runat="server" CssClass="form-control" Enabled="False"></asp:DropDownList>
                                                        </div>
                                                         <div class="form-group">
                                                             <asp:Label ID="lblRIPremiumAmount3" runat="server" Visible="false" Text="Label"></asp:Label><asp:HiddenField ID="hiddenRIPremiumAmount3" Value="0" runat="server" />
                                                         </div>
                                                    </div>
                                                </div>
                                                <div class="panel-heading col-sm-6">
                                                    <h4><span class="badge">&nbsp;Beneficiary 4:&nbsp;<asp:CheckBox ID="chkR4" CssClass="badge" Text="" runat="server" AutoPostBack="True" OnCheckedChanged="chkR4_CheckedChanged" /></span></h4>
                                                    <div class="panel-body">
                                                        <div class="form-group">
                                                            <label class="control-label">Surname</label>
														...
														<div class="form-group">
                                                            <label class="control-label">ID Number</label>
                                                            <asp:TextBox ID="txtRIIdNumber4" runat="server" CssClass="form-control" Enabled="False" onfocusout="validateID()"></asp:TextBox>
                                                        </div>
                                                        <div class="form-group">
                                                            <label class="control-label">Date of Birth</label>
                                                        ...
                                                        <div class="form-group">
                                                            <label class="control-label">Relationship to Member</label>
                                                            <asp:DropDownList ID="cmbRIRelationship4" OnSelectedIndexChanged="cmbRIRelationship4_SelectedIndexChanged" AutoPostBack="true" runat="server" CssClass="form-control" Enabled="False"></asp:DropDownList>
                                                        </div>
                                                        <div class="form-group">
                                                            <label class="control-label">Benefit Amount</label>
                                                            <asp:DropDownList ID="cmbRIBenefitAmount4" OnSelectedIndexChanged="cmbRIBenefitAmount4_SelectedIndexChanged" AutoPostBack="true" runat="server" CssClass="form-control" Enabled="False"></asp:DropDownList>
                                                        </div>
                                                         <div class="form-group">
                                                             <asp:Label ID="lblRIPremiumAmount4" runat="server" Visible="false" Text="Label"></asp:Label><asp:HiddenField ID="hiddenRIPremiumAmount4" Value="0" runat="server" />
                                                         </div>
                                                    </div>
                                                </div>
                                            </div>
                                        <div class="hr-line-dashed"></div>
                                            <div class="row">
                                                <div class="panel-heading col-sm-6 img-shadow">
                                                    <h4><span class="badge">&nbsp;Beneficiary 5:&nbsp;<asp:CheckBox ID="chkR5" CssClass="badge" Text="" runat="server" AutoPostBack="True" OnCheckedChanged="chkR5_CheckedChanged" /></span></h4>
                                                    <div class="panel-body">
                                                        <div class="form-group">
                                                            <label class="control-label">Surname</label>
														...
														<div class="form-group">
                                                            <label class="control-label">ID Number</label>
                                                            <asp:TextBox ID="txtRIIdNumber5" runat="server" CssClass="form-control" Enabled="False" onfocusout="validateID()"></asp:TextBox>
                                                        </div>
                                                        <div class="form-group">
                                                            <label class="control-label">Date of Birth</label>
                                                        ...
                                                        <div class="form-group">
                                                            <label class="control-label">Relationship to Member</label>
                                                            <asp:DropDownList ID="cmbRIRelationship5" OnSelectedIndexChanged="cmbRIRelationship5_SelectedIndexChanged" AutoPostBack="true" runat="server" CssClass="form-control" Enabled="False"></asp:DropDownList>
                                                        </div>
                                                        <div class="form-group">
                                                            <label class="control-label">Benefit Amount</label>
                                                            <asp:DropDownList ID="cmbRIBenefitAmount5" OnSelectedIndexChanged="cmbRIBenefitAmount5_SelectedIndexChanged" AutoPostBack="true" runat="server" CssClass="form-control" Enabled="False"></asp:DropDownList>
                                                        </div>
                                                         <div class="form-group">
                                                             <asp:Label ID="lblRIPremiumAmount5" runat="server" Visible="false" Text="Label"></asp:Label><asp:HiddenField ID="hiddenRIPremiumAmount5" Value="0" runat="server" />
                                                         </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="panel-heading col-sm-6 img-shadow">
                                                    ...
                                                    <div class="panel-body">
														...
														<div class="form-group">
                                                            <label class="control-label">ID Number</label>
                                                            <asp:TextBox ID="txtFRIdNumber1" runat="server" CssClass="form-control" Enabled="False" onfocusout="validateID()"></asp:TextBox>
                                                        </div>
                                                        <div class="form-group">
                                                            <label class="control-label">Date of Birth</label>
                                                        ...
                                                        <div class="form-group">
                                                            <label class="control-label">Relationship to Member</label>
                                                            <asp:DropDownList ID="cmbFRRelationship1" OnSelectedIndexChanged="cmbFRRelationship1_SelectedIndexChanged" AutoPostBack="true" runat="server" CssClass="form-control" Enabled="False"></asp:DropDownList>
                                                        </div>
                                                         <div class="form-group">
                                                            <label class="control-label">Benefit Amount</label>
                                                            <asp:DropDownList ID="cmbFRBenefitAmount1" OnSelectedIndexChanged="cmbFRBenefitAmount1_SelectedIndexChanged" AutoPostBack="true" runat="server" CssClass="form-control" Enabled="False"></asp:DropDownList>
                                                        </div>
                                                         <div class="form-group">
                                                             <asp:Label ID="lblFRPremiumAmount1" runat="server" Visible="false" Text="Label"></asp:Label><asp:HiddenField ID="hiddenFRPremiumAmount1" Value="0" runat="server" />
                                                         </div>
                                                    </div>
                                                </div>
                                            <div class="panel-heading col-sm-6">
                                                    ...
                                                    <div class="panel-body">
														...
														<div class="form-group">
                                                            <label class="control-label">ID Number</label>
                                                            <asp:TextBox ID="txtFRIdNumber2" runat="server" CssClass="form-control" Enabled="False" onfocusout="validateID()"></asp:TextBox>
                                                        </div>
                                                        <div class="form-group">
                                                            <label class="control-label">Date of Birth</label>
                                                        ...
                                                        <div class="form-group">
                                                            <label class="control-label">Relationship to Member</label>
                                                            <asp:DropDownList ID="cmbFRRelationship2" OnSelectedIndexChanged="cmbFRRelationship2_SelectedIndexChanged" AutoPostBack="true" runat="server" CssClass="form-control" Enabled="False"></asp:DropDownList>
                                                        </div>
                                                        <div class="form-group">
                                                            <label class="control-label">Benefit Amount</label>
                                                            <asp:DropDownList ID="cmbFRBenefitAmount2" OnSelectedIndexChanged="cmbFRBenefitAmount2_SelectedIndexChanged" AutoPostBack="true" runat="server" CssClass="form-control" Enabled="False"></asp:DropDownList>
                                                        </div>
                                                         <div class="form-group">
                                                             <asp:Label ID="lblFRPremiumAmount2" runat="server" Visible="false" Text="Label"></asp:Label><asp:HiddenField ID="hiddenFRPremiumAmount2" Value="0" runat="server" />
                                                         </div>
                                                    </div>
                                                </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="panel-heading col-sm-6 img-shadow">
                                                    ...
                                                    <div class="panel-body">
														...
														<div class="form-group">
                                                            <label class="control-label">ID Number</label>
                                                            <asp:TextBox ID="txtFRIdNumber3" runat="server" CssClass="form-control" Enabled="False" onfocusout="validateID()"></asp:TextBox>
                                                        </div>
                                                        <div class="form-group">
                                                            <label class="control-label">Date of Birth</label>
                                                        ...
                                                        <div class="form-group">
                                                            <label class="control-label">Relationship to Member</label>
                                                            <asp:DropDownList ID="cmbFRRelationship3" OnSelectedIndexChanged="cmbFRRelationship3_SelectedIndexChanged" AutoPostBack="true" runat="server" CssClass="form-control" Enabled="False"></asp:DropDownList>
                                                        </div>
                                                        <div class="form-group">
                                                            <label class="control-label">Benefit Amount</label>
                                                            <asp:DropDownList ID="cmbFRBenefitAmount3" OnSelectedIndexChanged="cmbFRBenefitAmount3_SelectedIndexChanged" AutoPostBack="true" runat="server" CssClass="form-control" Enabled="False"></asp:DropDownList>
                                                        </div>
                                                         <div class="form-group">
                                                             <asp:Label ID="lblFRPremiumAmount3" runat="server" Visible="false" Text="Label"></asp:Label><asp:HiddenField ID="hiddenFRPremiumAmount3" Value="0" runat="server" />
                                                         </div>
                                                    </div>
                                                </div>
                                            <div class="panel-heading col-sm-6">
                                                    ...
                                                    <div class="panel-body">
                                                        ...
                                                        <div class="form-group">
                                                            <label class="control-label">Relationship to Member</label>
                                                            <asp:DropDownList ID="cmbFRRelationship4" OnSelectedIndexChanged="cmbFRRelationship4_SelectedIndexChanged" AutoPostBack="true" runat="server" CssClass="form-control" Enabled="False"></asp:DropDownList>
                                                        </div>
                                                        <div class="form-group">
                                                            <label class="control-label">Benefit Amount</label>
                                                            <asp:DropDownList ID="cmbFRBenefitAmount4" OnSelectedIndexChanged="cmbFRBenefitAmount4_SelectedIndexChanged" AutoPostBack="true" runat="server" CssClass="form-control" Enabled="False"></asp:DropDownList>
                                                        </div>
                                                         <div class="form-group">
                                                             <asp:Label ID="lblFRPremiumAmount4" runat="server" Visible="false" Text="Label"></asp:Label><asp:HiddenField ID="hiddenFRPremiumAmount4" Value="0" runat="server" />
                                                         </div>
                                                    </div>
                                                </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="panel-heading col-sm-6 img-shadow">
                                                    ...
                                                    <div class="panel-body">
                                                        ...
                                                        <div class="form-group">
                                                            <label class="control-label">Relationship to Member</label>
                                                            <asp:DropDownList ID="cmbFRRelationship5" OnSelectedIndexChanged="cmbFRRelationship5_SelectedIndexChanged" AutoPostBack="true" runat="server" CssClass="form-control" Enabled="False"></asp:DropDownList>
                                                        </div>
                                                        <div class="form-group">
                                                            <label class="control-label">Benefit Amount</label>
                                                            <asp:DropDownList ID="cmbFRBenefitAmount5" OnSelectedIndexChanged="cmbFRBenefitAmount5_SelectedIndexChanged" AutoPostBack="true" runat="server" CssClass="form-control" Enabled="False"></asp:DropDownList>
                                                        </div>
                                                         <div class="form-group">
                                                             <asp:Label ID="lblFRPremiumAmount5" runat="server" Visible="false" Text="Label"></asp:Label><asp:HiddenField ID="hiddenFRPremiumAmount5" Value="0" runat="server" />
                                                         </div>
                                                    </div>
                                                </div>
                                        </div>
