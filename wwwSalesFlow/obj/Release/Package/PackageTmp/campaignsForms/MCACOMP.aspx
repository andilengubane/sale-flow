<%@ Page Title="" Language="C#" MasterPageFile="~/campaignsForms/principal.Master" AutoEventWireup="true" CodeBehind="MCACOMP.aspx.cs" Inherits="wwwSalesFlow.campaignsForms.MCACOMP" %>
                            ...
                            <div class="row">
                                    ...
                                    <div class="ibox float-e-margins">
                                        ...
                                        <div class="ibox-content form-horizontal">
                                            <div class="form-group">
                                                    ...
                                                    <div class="col-sm-4"><asp:TextBox ID="txtAddressNotes" runat="server" CssClass="form-control input-sm"></asp:TextBox></div>
                                                        </div>
                                              <div class="form-group">
                              ...
                              <div class="row">
                                <div class="col-lg-12">
                                    <div class="ibox float-e-margins">
                                        <div class="ibox-title">
                                            <h5>ADDITIONAL SALE OPPORTUNITY</h5>
                                            <div class="ibox-tools">
                                                <a class="collapse-link">
                                                    <i class="fa fa-chevron-up"></i>
                                                </a>
                                        ...
                                        <div class="ibox-content form-horizontal">
                                            ...
                                            <div class="hr-line-dashed"></div>
                                            <div class="form-group">
                                                    <label class="col-sm-2 control-label">*USSD</label>
                                                    <div class="col-sm-4"><asp:DropDownList ID="ddlUSSD" CssClass="form-control" runat="server">
                                                        <asp:ListItem Text="[ Please Select ]" Value="[ Please Select ]"></asp:ListItem>
                                                         <asp:ListItem Text="Yes" Value="Yes"></asp:ListItem>
                                                        <asp:ListItem Text="No" Value="No"></asp:ListItem>
                                                                          </asp:DropDownList></div>
                                            ...
                                            <div class="hr-line-dashed"></div>
                                            <div class="form-group">
                                                    <label class="col-sm-2 control-label">Price Increase</label>
                                                    <div class="col-sm-4"><asp:DropDownList ID="ddlPriceIncrease" CssClass="form-control" runat="server">
                                                        <asp:ListItem Text="[ Please Select ]" Value="[ Please Select ]"></asp:ListItem>
                                                         <asp:ListItem Text="Yes" Value="Yes"></asp:ListItem>
                                                        <asp:ListItem Text="No" Value="No"></asp:ListItem>
                                                                          </asp:DropDownList></div>
                                            ...
                                            <div class="hr-line-dashed"></div>
                                            <div class="form-group">
                                                    <label class="col-sm-2 control-label">Was Adhoc Loaded</label>
                                                    <div class="col-sm-4"><asp:DropDownList ID="ddlWasAdhocLoaded" CssClass="form-control" runat="server">
                                                        <asp:ListItem Text="[ Please Select ]" Value="[ Please Select ]"></asp:ListItem>
                                                         <asp:ListItem Text="Yes" Value="Yes"></asp:ListItem>
                                                        <asp:ListItem Text="No" Value="No"></asp:ListItem>
                                                                          </asp:DropDownList></div>
                                            ...
                                            <div class="hr-line-dashed"></div>
                                            <div class="form-group">
                                                    <label class="col-sm-2 control-label">DSTV Now Offered</label>
                                                    <div class="col-sm-4"><asp:DropDownList ID="ddlDSTVNowOffered" CssClass="form-control" runat="server">
                                                        <asp:ListItem Text="[ Please Select ]" Value="[ Please Select ]"></asp:ListItem>
                                                         <asp:ListItem Text="Yes" Value="Yes"></asp:ListItem>
                                                        <asp:ListItem Text="No" Value="No"></asp:ListItem>
                                                                          </asp:DropDownList></div>
                                            ...
                                            <div class="hr-line-dashed"></div>
                                            <div class="form-group">
                                                    <label class="col-sm-2 control-label">Advised on Catchup and Catch Up Plus</label>
                                                    <div class="col-sm-4"><asp:DropDownList ID="ddlAdvisedonCatchupandCatchUpPlus" CssClass="form-control" runat="server">
                                                        <asp:ListItem Text="[ Please Select ]" Value="[ Please Select ]"></asp:ListItem>
                                                         <asp:ListItem Text="Yes" Value="Yes"></asp:ListItem>
                                                        <asp:ListItem Text="No" Value="No"></asp:ListItem>
                                                                          </asp:DropDownList></div>
                                    ...
                                    <div class="ibox float-e-margins">
                                        ...
                                        <div class="ibox-content form-horizontal">
                                            <div class="row">
                                                ...
                                                <div class="row">
                                                    <div class="ibox-content form-horizontal">
                                                        <asp:Label ID="lblerror" runat="server" CssClass="label-info" Text="Please Select New Package" Visible="false" BackColor="White" Font-Bold="true" ForeColor="Red" ></asp:Label>
	                                                </div>
                                                    <div class="col-sm-12">
