<%@ Page Language="C#" MasterPageFile="~/campaignsForms/principal.Master" AutoEventWireup="true" CodeBehind="MCADOHL2.aspx.cs" Inherits="wwwSalesFlow.campaignsForms.MCADOHL2" %>
                                      ...
                                      <%--       <div class="form-group">
                                            ...
                                            <div class="form-group">
                                             ...
                                             <div class="form-group" style="visibility:hidden">
                                                    ...
                                                    <div class="col-sm-4"><asp:TextBox ID="txtMultichoiceID" runat="server" CssClass="form-control"></asp:TextBox>   </div>
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="ibox float-e-margins">
                                        ...
                                        <div class="ibox-content form-horizontal">
                                            <div class="form-group">
                                                    <label class="col-sm-2 control-label">*Debit Order Fail Reason</label>
                                                    <div class="col-sm-4"><asp:DropDownList ID="drpDebitOrderFailReason" CssClass="form-control" runat="server">
                                                        <asp:ListItem Text="[ Please Select ]" Value="[ Please Select ]"></asp:ListItem>
                                                        <asp:ListItem Text="New Bank Details" Value="New Bank Details"></asp:ListItem>
                                                        <asp:ListItem Text="Insufficient Fund" Value="Insufficient Fund"></asp:ListItem>
                                                        <asp:ListItem Text="Cancelled" Value="Cancelled"></asp:ListItem>
                                                        <asp:ListItem Text="NID" Value="NID"></asp:ListItem>
                                                        </asp:DropDownList>
                                                    </div>
                                                        </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                    ...
                                                    <div class="col-sm-4"><asp:DropDownList ID="drpRetentionOffer" CssClass="form-control" runat="server">
                                                        <asp:ListItem Text="[ Please Select ]" Value="[ Please Select ]"></asp:ListItem>
                                                        <asp:ListItem Text="Free Reconnection" Value="Free Reconnection"></asp:ListItem>
                                                        </asp:DropDownList>
                                                    </div>
                                                        </div>
                                        ...
                                        <div class="ibox-content form-horizontal">
                                            <div class="form-group">
                                                    ...
                                                    <div class="col-sm-4"><asp:DropDownList ID="ddlOldPackage" CssClass="form-control" runat="server">
                                                        ...
                                                        <asp:ListItem Text="Easy View" Value="Easy View"></asp:ListItem>
                                            ...
                                            <div class="form-group">
                                                    ...
                                                    <div class="col-sm-4"><asp:DropDownList ID="drpDPPOffer" CssClass="form-control" runat="server">
                                                        <asp:ListItem Text="[ Please Select ]" Value="[ Please Select ]"></asp:ListItem>
                                                        <asp:ListItem Text="Explorer Once Off" Value="Explorer Once Off"></asp:ListItem>
                                                        <asp:ListItem Text="DPP799" Value="DPP799"></asp:ListItem>
                                                        <asp:ListItem Text="DPP99" Value="DPP99"></asp:ListItem>
                                                        </asp:DropDownList>
                                                    </div>
                                                        </div>
                                             <div class="hr-line-dashed"></div>
                                            <div class="form-group">
                                                    ...
                                                    <div class="col-sm-4"><asp:DropDownList ID="drpDebitOrder" CssClass="form-control" runat="server">
                                                        <asp:ListItem Text="[ Please Select ]" Value="[ Please Select ]"></asp:ListItem>
                                            ...
                                            <div class="form-group">
                                                    ...
                                                    <div class="col-sm-4"><asp:DropDownList ID="drpR50OnceOffDiscountOffered" CssClass="form-control" runat="server">
                                                        <asp:ListItem Text="[ Please Select ]" Value="[ Please Select ]"></asp:ListItem>
                                                        <asp:ListItem Text="YES" Value="YES"></asp:ListItem>
                                            ...
                                            <div class="form-group">
                                                    ...
                                                    <div class="col-sm-4"><asp:DropDownList ID="drpR50OnceOffDiscountAccepted" CssClass="form-control" runat="server">
                                                        <asp:ListItem Text="[ Please Select ]" Value="[ Please Select ]"></asp:ListItem>
                                                        <asp:ListItem Text="YES" Value="YES"></asp:ListItem>
                                                        <asp:ListItem Text="NO" Value="NO"></asp:ListItem>
                                                        </asp:DropDownList>
                                            ...
                                            <div class="form-group">
                                                    ...
                                                    <div class="col-sm-4"><asp:DropDownList ID="drpSalaryDateAligned" CssClass="form-control" runat="server">
                                                        <asp:ListItem Text="[ Please Select ]" Value="[ Please Select ]"></asp:ListItem>
                                                        <asp:ListItem Text="YES" Value="YES"></asp:ListItem>
                                                        <asp:ListItem Text="NO" Value="NO"></asp:ListItem>
                                                        </asp:DropDownList>
                                            ...
                                            <div class="form-group">
                                                    ...
                                                    <div class="col-sm-4"><asp:DropDownList ID="drpDCCInsurance" CssClass="form-control" runat="server">
                                                        <asp:ListItem Text="[ Please Select ]" Value="[ Please Select ]"></asp:ListItem>
                                                        <asp:ListItem Text="YES" Value="YES"></asp:ListItem>
                                                        <asp:ListItem Text="NO" Value="NO"></asp:ListItem>
                                                        </asp:DropDownList>
                                            ...
                                            <div class="form-group">
                                                    ...
                                                    <div class="col-sm-4"><asp:DropDownList ID="drpConnectID" CssClass="form-control" runat="server">
                                                        <asp:ListItem Text="[ Please Select ]" Value="[ Please Select ]"></asp:ListItem>
                                                        <asp:ListItem Text="YES" Value="YES"></asp:ListItem>
                                                        <asp:ListItem Text="NO" Value="NO"></asp:ListItem>
                                                        </asp:DropDownList>
                                            ...
                                            <div class="hr-line-dashed"></div>
                                            <div class="form-group">
                                                    <label class="col-sm-2 control-label">Box Office</label>
                                                    <div class="col-sm-4"><asp:DropDownList ID="drpBoxOffice" CssClass="form-control" runat="server">
                                                        <asp:ListItem Text="[ Please Select ]" Value="[ Please Select ]"></asp:ListItem>
                                                        <asp:ListItem Text="YES" Value="YES"></asp:ListItem>
                                                        <asp:ListItem Text="NO" Value="NO"></asp:ListItem>
                                                        </asp:DropDownList>
                                            ...
                                            <div class="form-group">
                                                    ...
                                                    <div class="col-sm-4"><asp:DropDownList ID="drpCustomerOnlyInterestedInLockingServices" CssClass="form-control" runat="server">
                                                        <asp:ListItem Text="[ Please Select ]" Value="[ Please Select ]"></asp:ListItem>
                                                        <asp:ListItem Text="YES" Value="YES"></asp:ListItem>
                                                        <asp:ListItem Text="NO" Value="NO"></asp:ListItem>
                                                        </asp:DropDownList>
                                            ...
                                            <div class="form-group">
                                                    <label class="col-sm-2 control-label">Date Promised to Pay</label>
                                                      <div class="col-sm-4"><asp:TextBox ID="txtDatePromisedToPay" runat="server" TextMode="Date" CssClass="form-control input-sm"></asp:TextBox></div>
                                                        </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="ibox float-e-margins">
                                        ...
                                        <div class="ibox-content form-horizontal">
                                            ...
                                            <div class="form-group">
                                                    ...
                                                    <div class="col-sm-4"><asp:DropDownList ID="drpProducts" CssClass="form-control" runat="server">
                                                        <asp:ListItem Text="[ Please Select ]" Value="[ Please Select ]"></asp:ListItem>
                                                         <asp:ListItem Text="Premium 6 Activated" Value="Premium 6 Activated"></asp:ListItem>
                                                        <asp:ListItem Text="Premium 12 Activated" Value="Premium 12 Activated"></asp:ListItem>
                                                        <asp:ListItem Text="Premium 24 Activated" Value="Premium 24 Activated"></asp:ListItem>
                                                        <asp:ListItem Text="Premium+Access Fee 12 Activated" Value="Premium+Access Fee 12 Activated"></asp:ListItem>
                                                        <asp:ListItem Text="Premium+Access Fee 24 Activated" Value="Premium+Access Fee 24 Activated"></asp:ListItem>
                                                        <asp:ListItem Text="Compact Plus 3 R470" Value="Compact Plus 3 R470"></asp:ListItem>
                                                          <asp:ListItem Text="Compactplus 12 Activated" Value="Compactplus 12 Activated"></asp:ListItem>
                                                        <asp:ListItem Text="Compactplus 24 Activated" Value="Compactplus 24 Activated"></asp:ListItem>
                                                        <asp:ListItem Text="CompactPlus+Access Fee 12 Activated" Value="CompactPlus+Access Fee 12 Activated"></asp:ListItem>
                                                        <asp:ListItem Text="CompactPlus+Access Fee 24 Activated" Value="CompactPlus+Access Fee 24 Activated"></asp:ListItem>
                                                          <asp:ListItem Text="Compact 12 Activated" Value="Compact 12 Activated"></asp:ListItem>
                                                        <asp:ListItem Text="Compact 24 Activated" Value="Compact 24 Activated"></asp:ListItem>
                                                        <asp:ListItem Text="Compact+Access Fee 12 Activated" Value="Compact+Access Fee 12 Activated"></asp:ListItem>
                                                        <asp:ListItem Text="Compact+Access Fee 24 Activated" Value="Compact+Access Fee 24 Activated"></asp:ListItem>
                                                          <asp:ListItem Text="Family 6 Activated" Value="Family 6 Activated"></asp:ListItem>
                                                        <asp:ListItem Text="Family 12 Activated" Value="Family 12 Activated"></asp:ListItem>
                                                        <asp:ListItem Text="Family 24 Activated" Value="Family 24 Activated"></asp:ListItem>
                                                        <asp:ListItem Text="Family+Acess Fee 12 Activated" Value="Family+Acess Fee 12 Activated"></asp:ListItem>
                                                          <asp:ListItem Text="Family+Access Fee 24 Activated" Value="Family+Access Fee 24 Activated"></asp:ListItem>
                                                        <asp:ListItem Text="Access 6 Activated" Value="Access 6 Activated"></asp:ListItem>
                                                        <asp:ListItem Text="Access 12 Activated" Value="Access 12 Activated"></asp:ListItem>
                                                        <asp:ListItem Text="Access 24 Activated" Value="Access 24 Activated"></asp:ListItem>
                                                          <asp:ListItem Text="Access+Access Fee 12 Activated" Value="Access+Access Fee 12 Activated"></asp:ListItem>
                                                        <asp:ListItem Text="Access+Access Fee 24 Activated" Value="Access+Access Fee 24 Activated"></asp:ListItem>
                                                        <asp:ListItem Text="SPL Activation Issue - BSD" Value="SPL Activation Issue - BSD"></asp:ListItem>
                                                        <asp:ListItem Text="Reconnected Premium" Value="Reconnected Premium"></asp:ListItem>
                                                          <asp:ListItem Text="Reconnected Compactplus" Value="Reconnected Compactplus"></asp:ListItem>
                                                        <asp:ListItem Text="Reconnected CompactPlus" Value="Reconnected CompactPlus"></asp:ListItem>
                                                        <asp:ListItem Text="Reconnected Family" Value="Reconnected Family"></asp:ListItem>
                                                        <asp:ListItem Text="Reconnected Access" Value="Reconnected Access"></asp:ListItem>
                                                          <asp:ListItem Text="Reconnected Easy View" Value="Reconnected Easy View"></asp:ListItem>
                                                        <asp:ListItem Text="Upgrade Premium" Value="Upgrade Premium"></asp:ListItem>
                                                        <asp:ListItem Text="Upgrade Compactplus" Value="Upgrade Compactplus"></asp:ListItem>
                                                        <asp:ListItem Text="Upgrade Family" Value="Upgrade Family"></asp:ListItem>
                                                          <asp:ListItem Text="Upgrade Access" Value="Upgrade Access"></asp:ListItem>
                                                        <asp:ListItem Text="DOL IP date aligned-Sal date" Value="DOL IP date aligned-Sal date"></asp:ListItem>
                                                        <asp:ListItem Text="DOL-IP date not aligned" Value="DOL-IP date not aligned"></asp:ListItem>
