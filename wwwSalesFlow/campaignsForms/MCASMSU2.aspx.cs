...
{
    public partial class MCASMSU2 : System.Web.UI.Page
    {
        ...
        {
            List<BusinessLogic.Campaigns.MCA.ProductsSMSU2> lstProducts = BusinessLogic.Campaigns.MCA.ProductsSMSU2.GetProducts();
            BusinessLogic.Campaigns.MCA.ProductsSMSU2 dummyProducts = new BusinessLogic.Campaigns.MCA.ProductsSMSU2();
            ...
            drpProducts.DataSource = lstProducts;
                    ...
                    if (ws.Found)
                    {
                        ...
                        if (ViewState["SaleID"] != null)
                        {
                            ...
                            if (saleID > 0)
                            {
                                ...
                                // Save Sale Details
                                int saleDetails = BusinessLogic.Campaigns.MCA.SaleDetailsSMSU2.CreateSaleDetail(saleID, drpDebitOrderFailReason.Text, ddlOldPackage.Text, ddlUpgrade.Text, ddlNewPackage.Text, drpRetentionOffer.Text, drpDPPOffer.Text, drpDebitOrder.Text, drpR50OnceOffDiscountOffered.Text, drpR50OnceOffDiscountAccepted.Text, txtFinancialAccountNumber.Text, drpSalaryDateAligned.Text, drpDCCInsurance.Text, drpConnectID.Text, drpBoxOffice.Text, drpCustomerOnlyInterestedInLockingServices.Text, txtMoneyToPay.Text, txtMoneyPaid.Text, txtDatePromisedToPay.Text, drpProducts.Text, DateTime.Now, DateTime.Now, currentUser.ID.ToString(), currentUser.ID.ToString());
