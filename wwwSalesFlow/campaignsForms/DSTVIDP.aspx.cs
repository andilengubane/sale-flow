...
{
    public partial class DSTVIDP : System.Web.UI.Page
    {
        ...
        {
            List<BusinessLogic.Campaigns.MCA.ProductsDSTVIDP> lstProducts = BusinessLogic.Campaigns.MCA.ProductsDSTVIDP.GetProducts();
            BusinessLogic.Campaigns.MCA.ProductsDSTVIDP dummyProducts = new BusinessLogic.Campaigns.MCA.ProductsDSTVIDP();
                        ...
                        if (ws.Found)
                        {
                            ...
                            if (ViewState["SaleID"] != null)
                            {
                                ...
                                if (saleID > 0)
                                {
                                    ...
                                    // Save Sale Details
                                    int saleDetails = BusinessLogic.Campaigns.MCA.SaleDetailsDSTVIDP.CreateSaleDetail(saleID, (ddlRetained.SelectedItem.Text == "Yes"), txtMultichoiceID.Text.Trim(), Convert.ToInt32(ddlProduct.SelectedValue), (ddlExceptionAddress.SelectedItem.Text == "Yes"), ddlUpOrDown.SelectedItem.Text,
