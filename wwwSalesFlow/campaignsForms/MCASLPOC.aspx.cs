...
{
    public partial class MCASLPOC : System.Web.UI.Page
    {
        ...
        {
            List<BusinessLogic.Campaigns.MCA.ProductsSLPOC> lstProducts = BusinessLogic.Campaigns.MCA.ProductsSLPOC.GetProducts();
            BusinessLogic.Campaigns.MCA.ProductsSLPOC dummyProducts = new BusinessLogic.Campaigns.MCA.ProductsSLPOC();
                        ...
                        if (ws.Found)
                        {
                            ...
                            if (ViewState["SaleID"] != null)
                            {
                                ...
                                if (saleID > 0)
                                {
                                    ...
                                    // Save Sale Details
                                    int saleDetails = BusinessLogic.Campaigns.MCA.SaleDetailsSLPOC.CreateSaleDetail(saleID, (ddlRetained.SelectedItem.Text == "Yes"), txtMultichoiceID.Text.Trim(), Convert.ToInt32(ddlProduct.SelectedValue), (ddlExceptionAddress.SelectedItem.Text == "Yes"), ddlUpOrDown.SelectedItem.Text,
