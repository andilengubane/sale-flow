...
{
    public partial class MCAPLCAT : System.Web.UI.Page
    {
        ...
        {
            List<BusinessLogic.Campaigns.MCA.ProductsPLCAT> lstProducts = BusinessLogic.Campaigns.MCA.ProductsPLCAT.GetProducts();
            BusinessLogic.Campaigns.MCA.ProductsPLCAT dummyProducts = new BusinessLogic.Campaigns.MCA.ProductsPLCAT();
                        ...
                        if (ws.Found)
                        {
                            ...
                            if (ViewState["SaleID"] != null)
                            {
                                ...
                                if (saleID > 0)
                                {
                                    ...
                                    // Save Sale Details
                                    int saleDetails = BusinessLogic.Campaigns.MCA.SaleDetailsPLCAT.CreateSaleDetail(saleID, (ddlRetained.SelectedItem.Text == "Yes"), txtMultichoiceID.Text.Trim(), Convert.ToInt32(ddlProduct.SelectedValue), (ddlExceptionAddress.SelectedItem.Text == "Yes"), ddlUpOrDown.SelectedItem.Text,
