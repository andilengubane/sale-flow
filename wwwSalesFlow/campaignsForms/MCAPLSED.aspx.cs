...
{
    public partial class MCAPLSED : System.Web.UI.Page
    {
        ...
        {
            List<BusinessLogic.Campaigns.MCA.ProductsPLSED> lstProducts = BusinessLogic.Campaigns.MCA.ProductsPLSED.GetProducts();
            BusinessLogic.Campaigns.MCA.ProductsPLSED dummyProducts = new BusinessLogic.Campaigns.MCA.ProductsPLSED();
                        ...
                        if (ws.Found)
                        {
                            ...
                            if (ViewState["SaleID"] != null)
                            {
                                ...
                                if (saleID > 0)
                                {
                                    ...
                                    // Save Sale Details
                                    int saleDetails = BusinessLogic.Campaigns.MCA.SaleDetailsPLSED.CreateSaleDetail(saleID, (ddlRetained.SelectedItem.Text == "Yes"), txtMultichoiceID.Text.Trim(), Convert.ToInt32(ddlProduct.SelectedValue), (ddlExceptionAddress.SelectedItem.Text == "Yes"), ddlUpOrDown.SelectedItem.Text,
