...
{
    public partial class MCAEXBUP : System.Web.UI.Page
    {
        ...
        {
            List<BusinessLogic.Campaigns.MCA.ProductsEXBUP> lstProducts = BusinessLogic.Campaigns.MCA.ProductsEXBUP.GetProducts();
            BusinessLogic.Campaigns.MCA.ProductsEXBUP dummyProducts = new BusinessLogic.Campaigns.MCA.ProductsEXBUP();
                        ...
                        if (ws.Found)
                        {
                            ...
                            if (ViewState["SaleID"] != null)
                            {
                                ...
                                if (saleID > 0)
                                {
                                    ...
                                    // Save Sale Details
                                    int saleDetails = BusinessLogic.Campaigns.MCA.SaleDetailsEXBUP.CreateSaleDetail(saleID, (ddlRetained.SelectedItem.Text == "Yes"), txtMultichoiceID.Text.Trim(), Convert.ToInt32(ddlProduct.SelectedValue), (ddlExceptionAddress.SelectedItem.Text == "Yes"), ddlUpOrDown.SelectedItem.Text,
