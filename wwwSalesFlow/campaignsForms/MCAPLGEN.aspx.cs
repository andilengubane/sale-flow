...
{
    public partial class MCAPLGEN : System.Web.UI.Page
    {
        ...
        {
            List<BusinessLogic.Campaigns.MCA.ProductsPLGEN> lstProducts = BusinessLogic.Campaigns.MCA.ProductsPLGEN.GetProducts();
            BusinessLogic.Campaigns.MCA.ProductsPLGEN dummyProducts = new BusinessLogic.Campaigns.MCA.ProductsPLGEN();
                        ...
                        if (ws.Found)
                        {
                            ...
                            if (ViewState["SaleID"] != null)
                            {
                                ...
                                if (saleID > 0)
                                {
                                    ...
                                    // Save Sale Details
                                    int saleDetails = BusinessLogic.Campaigns.MCA.SaleDetailsPLGEN.CreateSaleDetail(saleID, (ddlRetained.SelectedItem.Text == "Yes"), txtMultichoiceID.Text.Trim(), Convert.ToInt32(ddlProduct.SelectedValue), (ddlExceptionAddress.SelectedItem.Text == "Yes"), ddlUpOrDown.SelectedItem.Text,
