...
{
    public partial class MCAWEBLP : System.Web.UI.Page
    {
        ...
        {
            List<BusinessLogic.Campaigns.MCA.ProductsWEBLP> lstProducts = BusinessLogic.Campaigns.MCA.ProductsWEBLP.GetProducts();
            BusinessLogic.Campaigns.MCA.ProductsWEBLP dummyProducts = new BusinessLogic.Campaigns.MCA.ProductsWEBLP();
                        ...
                        if (ws.Found)
                        {
                            ...
                            if (ViewState["SaleID"] != null)
                            {
                                ...
                                if (saleID > 0)
                                {
                                    ...
                                    // Save Sale Details
                                    int saleDetails = BusinessLogic.Campaigns.MCA.SaleDetailsWEBLP.CreateSaleDetail(saleID, (ddlRetained.SelectedItem.Text == "Yes"), txtMultichoiceID.Text.Trim(), Convert.ToInt32(ddlProduct.SelectedValue), (ddlExceptionAddress.SelectedItem.Text == "Yes"), ddlUpOrDown.SelectedItem.Text,
