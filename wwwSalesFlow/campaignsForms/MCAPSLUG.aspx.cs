...
{
    public partial class MCAPSLUG : System.Web.UI.Page
    {
                    ...
                    if (ws.Found)
                    {
                        ...
                        if (ViewState["SaleID"] != null)
                        {
                            ...
                            if (saleID > 0)
                            {
                                ...
                                // Save Sale Details
                                int saleDetails = BusinessLogic.Campaigns.MCA.SaleDetailsPSLUG.CreateSaleDetail(saleID, txtNotes.Text.Trim(), txtAddressLine1.Text.Trim(), txtAddressLine1.Text.Trim(), txtSuburb.Text.Trim(), txtCity.Text.Trim(), txtPostalCode.Text.Trim(), ddlOffer.Text, ddlDebitOrder.Text, ddlDCCInsurance.Text, ddlCustomeronlyinterestedinlockingservices.Text, txtMoneyToPay.Text.Trim(), txtMoneyPaid.Text.Trim(), txtDatePromisedtoPay.Text.Trim(), DateTime.Now, DateTime.Now, currentUser.ID.ToString(), currentUser.ID.ToString());
                    ...
                    if (ws.Found)
                    {
                        ...
                        if (ViewState["SaleID"] != null)
                        {
                            ...
                            if (saleID > 0)
                            {
                                ...
                                int personalDetails = PersonalDetails.SavePersonalDetails(saleID, cmbTitle.SelectedValue, "", txtFirstname.Text, "", txtSurname.Text, txtIdNumber.Text, "", DateTime.Now, txtTelWork.Text, txtTelCell.Text, "", "", "", txtAddressLine1.Text, txtAddressLine2.Text, txtSuburb.Text, "", "", txtPostalCode.Text, "", 0);
                                // Save Sale Details
                                int saleDetails = BusinessLogic.Campaigns.MCA.SaleDetailsPSLUG.CreateSaleDetail(saleID, txtNotes.Text.Trim(), txtAddressLine1.Text.Trim(), txtAddressLine2.Text.Trim(), txtSuburb.Text.Trim(), txtCity.Text.Trim(), txtPostalCode.Text.Trim(), ddlOffer.Text, ddlDebitOrder.Text, ddlDCCInsurance.Text, ddlCustomeronlyinterestedinlockingservices.Text, txtMoneyToPay.Text.Trim(), txtMoneyPaid.Text.Trim(), txtDatePromisedtoPay.Text.Trim(), DateTime.Now, DateTime.Now, currentUser.ID.ToString(), currentUser.ID.ToString());
                            }
                            else
                            {
                                lblConfirmation.Text = string.Format("Sale {0} not saved... <br/> Please escalate to admin", sal.ID.ToString());
