...
{
    public partial class MCAPLSD : System.Web.UI.Page
    {
        ...
        {
            List<BusinessLogic.Campaigns.MCA.ProductsPLSD> lstProducts = BusinessLogic.Campaigns.MCA.ProductsPLSD.GetProducts();
            BusinessLogic.Campaigns.MCA.ProductsPLSD dummyProducts = new BusinessLogic.Campaigns.MCA.ProductsPLSD();
                    ...
                    if (ws.Found)
                    {
                        ...
                        if (ViewState["SaleID"] != null)
                        {
                            ...
                            if (saleID > 0)
                            {
                                ...
                                // Save Sale Details
                                int saleDetails = BusinessLogic.Campaigns.MCA.SaleDetailsPLSD.CreateSaleDetail(saleID, (ddlRetained.SelectedItem.Text == "Yes"), txtMultichoiceID.Text.Trim(), Convert.ToInt32(ddlProduct.SelectedValue), (ddlExceptionAddress.SelectedItem.Text == "Yes"), ddlUpOrDown.SelectedItem.Text,
                                     ...
                                     ddlSaleAwaitingDocuments.SelectedItem.Text, txtIncome.Text.Trim(), ddlNonFinancialAccount.SelectedItem.Text, ddlReferralSale.SelectedItem.Text, ddlSalesOrderNumberGenerate.SelectedItem.Text, true, DateTime.Now, DateTime.Now, currentUser.ID.ToString(), currentUser.ID.ToString());
