...
{
    public partial class MCACOMP : System.Web.UI.Page
    {
        ...
        {
            List<BusinessLogic.Campaigns.MCA.ProductsCOMP> lstProducts = BusinessLogic.Campaigns.MCA.ProductsCOMP.GetProducts();
            BusinessLogic.Campaigns.MCA.ProductsCOMP dummyProducts = new BusinessLogic.Campaigns.MCA.ProductsCOMP();
            ...
            ddlOldPackage.DataValueField = "ProductID";
            ddlOldPackage.DataSource = lstProducts;
            ddlOldPackage.DataBind();

            ddlNewPackage.DataTextField = "Title";
            ddlNewPackage.DataValueField = "ProductID";
            ddlNewPackage.DataSource = lstProducts;
                        ...
                        if (ws.Found)
                        {
                            ...
                            if (ViewState["SaleID"] != null)
                            {
                                ...
                                if (saleID > 0)
                                {
                                    ...
                                    // Save Sale Details
                                    int saleDetails = BusinessLogic.Campaigns.MCA.SaleDetailsCOMP.CreateSaleDetail(saleID, ddlPaymentMethod.Text, ddlWillcustomerbuyHardwarefromRetailer.Text, ddlEscalatedtoFieldServicesforinstallation.Text, ddlCaptureCustomersresidentialaddress.Text, ddlOldPackage.Text, ddlUpgrade.Text, ddlNewPackage.Text, ddlAdons.Text, txtNotes.Text.Trim(), txtAddressLine1.Text.Trim(), txtAddressLine1.Text.Trim(), txtSuburb.Text.Trim(), txtCity.Text.Trim(), txtPostalCode.Text.Trim(), ddlOffer.Text, ddlDebitOrder.Text, ddlDCCInsurance.Text, ddlUSSD.Text, ddlPriceIncrease.Text, ddlWasAdhocLoaded.Text, ddlDSTVNowOffered.Text, ddlAdvisedonCatchupandCatchUpPlus.Text, ddlCustomeronlyinterestedinlockingservices.Text, txtMoneyToPay.Text.Trim(), txtMoneyPaid.Text.Trim(), txtDatePromisedtoPay.Text.Trim(), DateTime.Now, DateTime.Now, currentUser.ID.ToString(), currentUser.ID.ToString());
