...
{
    public partial class MCABOX : System.Web.UI.Page
    {
                    ...
                    if (ws.Found)
                    {
                        ...
                        if (ViewState["SaleID"] != null)
                        {
                            ...
                            if (saleID > 0)
                            {
                                ...
                                // Save Sale Details
                                int saleDetails = BusinessLogic.Campaigns.MCA.SaleDetailsBOX.CreateSaleDetail(saleID, txtNotes.Text.Trim(), "", "", "", "", "", "", "", "", "", "", "", "", DateTime.Now, DateTime.Now, currentUser.ID.ToString(), currentUser.ID.ToString());
