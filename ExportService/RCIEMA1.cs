...
namespace ExportService
{
    public class RCIEMA1
    {
        public static void DoExport()
        {
            ...
            {
                List<Campaign> campaign = Campaign.GetCampaignsByCampaignName("RCIEMA1");
                ...
                File.WriteAllText(@"C:\RCIEMA1_SalesExport_"+ DateTime.Now.ToString("yyyyMMdd") +".csv", exportWithBankingDetailsToCsvFile.ToString());
                string fileUploadWithbankingDetails = @"C:\RCIEMA1_SalesExport_"+ DateTime.Now.ToString("yyyyMMdd") +".csv";
                ...
                if (total > 0)
                {
                    ExportFileToSFTP.UplaodRCABSA4ToSFTP(fileUploadWithbankingDetails, "/Iemas/Sales Files");
                    EmailExportSingleFile.SendEmailSingleFile("RCIEMA1", "RCIEMA1_SalesExport_" + DateTime.Now.ToString("yyyyMMdd") +".csv",
