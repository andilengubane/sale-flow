...
namespace ExportService
{
    public class RCNEBANK
    {
        public static void DoExport()
        {
            ...
            {
                List<Campaign> campaign = Campaign.GetCampaignsByCampaignName("RCNEBANK");
                ...
                File.WriteAllText(@"C:\RCNEBANK_SalesExport_" + DateTime.Now.ToString("yyyyMMdd") + ".csv", exportWithBankingDetailsToCsvFile.ToString());
                string fileUploadWithbankingDetails = @"C:\RCNEBANK_SalesExport_" + DateTime.Now.ToString("yyyyMMdd") + ".csv";
                ...
                if (total > 0)
                {
                    ExportFileToSFTP.UplaodRCABSA4ToSFTP(fileUploadWithbankingDetails, "/Nedbank/Sales Files");
                    EmailExportSingleFile.SendEmailSingleFile("RCNEBANK", "RCNEBANK_SalesExport_" + DateTime.Now.ToString("yyyyMMdd") + ".csv",
