...
namespace ExportService
{
    public class RCABSACM
    {
        public static void DoExport()
        {
            ...
            {
                List<Campaign> campaign = Campaign.GetCampaignsByCampaignName("RCABSACM");
                ...
                File.WriteAllText(@"C:\RCABSA_SalesExport_CMM_" + DateTime.Now.ToString("yyyyMMdd") + ".csv", exportWithBankingDetailsToCsvFile.ToString());
                string fileUploadWithbankingDetails = @"C:\RCABSA_SalesExport_CMM_" + DateTime.Now.ToString("yyyyMMdd") + ".csv"; 
                ...
                if (total > 0)
                {
                    ...
                    EmailExportSingleFile.SendEmailSingleFile("RCABSACM", "RCABSA_SalesExport_CMM_" + DateTime.Now.ToString("yyyyMMdd") + ".csv",
